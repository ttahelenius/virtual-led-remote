...
The GUI itself should be runnable as is, via the entry point in controller.Controller.java for Java 8 or newer.

![image](https://github.com/user-attachments/assets/b914f56b-bfee-4a47-a387-8124363e66ef)

However, it's not of much use without appropriate configuration, namely one should create ```config.properties``` file in the project root. This is documented
